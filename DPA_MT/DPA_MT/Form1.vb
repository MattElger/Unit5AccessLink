...
Public Class Form1
    ...
    Private Sub RunCMD(ByVal strDDL As String, ByRef CON As OleDbConnection)
        ...
        End Try
    End Sub
    'CREATE TABLE tblItem(StockID CHAR(3) NOT NULL PRIMARY KEY,Description VARCHAR(24) NOT NULL,Price SINGLE,QuantityInStock INTEGER,ReorderLevel INTEGER,ReorderQuantity INTEGER)
